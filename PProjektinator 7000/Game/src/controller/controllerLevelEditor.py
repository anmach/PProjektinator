...
class ControllerLevelEditor(Controller):
    ...
    def communicateMV(self, model, view):
        view.set_model(model.get_level_to_edit_number(), model.get_new_platform_first_vertex_pos(), model.get_new_platform_second_vertex_pos(), model.get_mode(), model.get_all_sprites())
